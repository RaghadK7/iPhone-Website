...
const VideoCarousel = () => {
  ...
  width: "100%",
  duration: videoRef.current[videoId]?.duration || 5, // مدة الفيديو أو 5 ثواني
  paused: !isPlaying,
  onUpdate() {
 ...
 if (videoId === 0)
    ...
    const animationUpdate =() => {
        animation.progress(videoRef.current[videoId] / hightlightsSlides[videoId].videoDuration);
    }
