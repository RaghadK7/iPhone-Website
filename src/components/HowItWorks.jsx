...
const HowItWorks = () => {
    ...
    useGSAP(() => {
        ...
        animateWithGsap('.g_fadeIn', { y: 0, opacity: 1 }, { delay: 1.5 })
        animateWithGsap('.fadeIn_text', { y: 0, opacity: 1 }, { delay: 1.7 })
    }, []);
                ...
                <div className='mt-10 md:mt-20 mb-14'>
                    <div className='flex-center'>
                        <div className='relative w-full max-w-4xl'>
                            ...
                            <video 
                                className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none object-cover w-5/10 h-5/6 z-10 ' 
                                playsInline 
                                preload='none' 
                                muted 
                                autoPlay 
